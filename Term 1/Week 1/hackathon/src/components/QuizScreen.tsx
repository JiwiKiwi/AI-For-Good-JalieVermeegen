...
export default function QuizScreen({ levelName, quizTitle, questions, onSubmit, onQuit }: QuizScreenProps) {
    ...
    <div className="math-texture animated-gradient animate-gradient-drift flex min-h-full flex-col">
      ...
      <div className="relative z-10 flex items-center justify-between px-6 py-5 sm:px-10">
        ...
        <div className="flex flex-col items-center">
          <span className="rounded-full bg-brand-500/10 px-5 py-1.5 text-sm font-semibold text-brand-700">
            {levelName}
          </span>
          <span className="mt-1 text-xs font-medium text-brand-500/70">
            {quizTitle}
          </span>
        </div>
      ...
      <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 py-8">
        ...
        >
          ...
          {/* Next / Submit button — directly under the answer area */}
